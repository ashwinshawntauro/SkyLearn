    ...
    <div className="grid main-live-grid">
      ...
      <div className="flex flex-col justify-center p-2">
        ...
        <div className="grid stream-grid p-2">
          <div>
            <Button id="video" className="z-10 px-7" onClick={initConnection}>Start Class</Button>
            <Button id="video" className="z-10 px-7 bg-red-500 hover:bg-red-400" onClick={stopBroadcast}>Stop Class</Button>
            <video
